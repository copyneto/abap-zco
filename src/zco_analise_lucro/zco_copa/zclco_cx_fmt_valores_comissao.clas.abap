class ZCLCO_CX_FMT_VALORES_COMISSAO definition
  public
...
public section.
  ...
  data STANDARD type ZCLCO_EXCHANGE_FAULT_DATA read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLCO_EXCHANGE_FAULT_DATA optional
...
CLASS ZCLCO_CX_FMT_VALORES_COMISSAO IMPLEMENTATION.
