...
FORM f_monta_tabela .
  ...
  ELSE.
    ...
    CREATE DATA wa_table LIKE LINE OF <fs_data>.
    ASSIGN wa_table->* TO <fs_wadata>.
  ENDIF.
...
FORM f_monta_tabela2 .
  ...
  ELSE.
    ...
    CREATE DATA wa_table2 LIKE LINE OF <fs_data2>.
    ASSIGN wa_table2->* TO <fs_wadata2>.
  ENDIF.
...
FORM f_grava_dados .
  ...
  IF NOT lt_saida IS INITIAL.
    ...
    LOOP AT lt_saida INTO wa_saida.
      ...
      MOVE wa_saida-line TO lv_aux.

      LOOP AT lt_dd03l INTO wa_dd03l.

        ASSIGN COMPONENT wa_dd03l-fieldname
...
*  unassign: <fs_wadata>,  <fs_field>.
  ...
  IF NOT lt_saida2 IS INITIAL.
    ...
    LOOP AT lt_saida2 INTO wa_saida.

      MOVE wa_saida-line TO lv_aux.

      LOOP AT lt_dd03l2 INTO wa_dd03l.
...
FORM f_monta_centros .
  ...
  DATA:
    ...
    wa_hie   TYPE bapi1116_values.


  SORT lt_centro BY groupname.
  LOOP AT lt_bapi ASSIGNING FIELD-SYMBOL(<wa_bapi>).
    lv_cont  = 0.

    READ TABLE lt_centro TRANSPORTING NO FIELDS WITH KEY groupname = <wa_bapi>-groupname BINARY SEARCH.
    IF sy-subrc = 0.
      lv_tabix = sy-tabix.
      LOOP AT lt_centro INTO DATA(wa_centro) FROM lv_tabix.
        IF wa_centro-groupname <> <wa_bapi>-groupname.
          EXIT.
        ELSE.
          lv_cont  = lv_cont  + 1.

          MOVE wa_centro-valfrom TO wa_hie-valfrom.
          MOVE wa_centro-valfrom TO wa_hie-valto  .
          APPEND wa_hie TO lt_hierarchyvalues.
